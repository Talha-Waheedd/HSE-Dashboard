...
async function run() {
  try {
    ...
    // Parse CSV
    const csvPath = 'C:\\Users\\talha\\.gemini\\antigravity-ide\\brain\\2ca2472f-9cbb-4c47-b782-e9f0501ff4af\\.user_uploaded\\media_1787390836535.csv';
    const fileContent = fs.readFileSync(csvPath, 'utf8');
    
    const lines = fileContent.split('\n');
    // Skip the first line "HAZARD SPOTTING,,,,,,"
    ...
    for (const r of records) {
      ...
      const hazard = {
        ...
        metadata: {
          ...
          remarks: r['Remarks'] || '',
          hazard_category: r['Hazard Category'] || '',
          status_csv: r['Status'] || ''
        }
      };
